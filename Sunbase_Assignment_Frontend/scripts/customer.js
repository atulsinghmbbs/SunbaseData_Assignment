            ...
            if (customers.length === 0) {
                ...
                customers.forEach(customer => {
                    ...
                    tr.innerHTML = `
                        ...
                        <td><button style="background-color: green;" class="btn btn-secondary" onclick="customerUpdateHandler(${customer.customerId})">Edit</button></td>
                        <td><button style="background-color: red;" class="btn btn-secondary" onclick="deleteCustomer(${customer.customerId})">Delete</button></td>
                    `;
...
async function customerUpdateHandler(id) {
    customerId = id;    //updatecustomer id for update to current id
...
function openUpdateCustomerPopup(customer) {
    ...
    document.getElementById('Password').value = customer.address;
